            ...
            {customers.length === 0 ? (
              ...
              pagedCustomers.map((c, idx) => (
                ...
                >
                  ...
                  <td className="px-1 py-1 border-r" style={{ position: 'relative', textAlign: 'center' }}>
                    <input
                      type="date"
                      value={c.installDate}
                    ...
                    />
                    <span className="text-xs" style={{ pointerEvents: 'none', display: 'inline-block', width: '100%', textAlign: 'center' }}>
